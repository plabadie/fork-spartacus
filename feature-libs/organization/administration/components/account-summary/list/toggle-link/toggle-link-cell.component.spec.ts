...
class MockUnitTreeService implements Partial<AccountSummaryTreeService> {
  toggle = createSpy('toggle');
}

describe('ToggleLinkCellComponent', () => {
  let component: ToggleLinkCellComponent;
  let unitTreeService: AccountSummaryTreeService;
  ...
  beforeEach(() => {
    ...
    unitTreeService = TestBed.inject(AccountSummaryTreeService);
