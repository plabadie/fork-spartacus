...
import { AccountSummaryFormComponent } from './account-summary-form.component';
...
describe('AccountSummaryFormComponent', () => {
  let component: AccountSummaryFormComponent;
  let fixture: ComponentFixture<AccountSummaryFormComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [AccountSummaryFormComponent, FormErrorsComponent],
      providers: [
        { provide: OrgUnitService, useClass: MockOrgUnitService },
        { provide: AccountSummaryItemService, useClass: MockItemService },
      ],
    }).compileComponents();
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AccountSummaryFormComponent);
  ...
  describe('createUidWithName', () => {
    it('should set uid field value if empty based on provided name value', () => {
      component.form.get('name').patchValue('Account Summary Test Value');
      ...
      expect(component.form.get('uid').value).toEqual('account-summary-test-value');
    });
